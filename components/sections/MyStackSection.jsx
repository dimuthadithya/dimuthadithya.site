...
const TECH_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Canva', src: '/images/Icons/canva.svg' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Chrome', src: '/images/Icons/chrome.svg' },
    ],
  },
];
...
/**
 * "My Stack" section with all tech categories.
 */
export default function MyStackSection() {
  return (
    <div id='stack'>
      <SectionHeading highlightedWord='my' restText='stack' />
      <motion.div
